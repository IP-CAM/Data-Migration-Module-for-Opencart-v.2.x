<div id="migration-page">
    <div class="page-header">
        ...
        <div class="redirect-icon"><a href="<?php echo $migration_url ?>" title="Migration"><span class="icon-migrate"></span></a></div>
    </div>
    ...
    <div class="migration-content">
        ...
        <div id="setting-wrap" class="wrap-box">
            <form id="setting-form" action="<?php echo $setting_url ?>" method="POST" enctype="application/x-www-form-urlencoded">
